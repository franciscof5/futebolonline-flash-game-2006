...
lib.ssMetadata = [
		{name:"futebolonline_2017_man_Canvas_unused_noglow_atlas_", frames: [[0,776,449,270],[502,425,500,337],[642,247,99,99],[0,0,640,423],[642,0,350,245],[0,1048,400,261],[0,425,500,349],[994,0,10,10],[502,764,424,300]]}
];
...
(lib._2250246 = function() {
	this.spriteSheet = ss["futebolonline_2017_man_Canvas_unused_noglow_atlas_"];
	this.gotoAndStop(0);
...
(lib.CorreiosLogotipo = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["futebolonline_2017_man_Canvas_unused_noglow_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-49,-48.9)).s().p("Am3BkIAAjHINvAAIAADHg");
...
(lib.IconePlantel = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["futebolonline_2017_man_Canvas_unused_noglow_atlas_"],7), null, new cjs.Matrix2D(0.373,0,0,0.373,-189,-46.3)).s().p("");
...
// stage content:
(lib.futebolonline2017man_Canvas_unused_noglow = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/futebolonline_2017_man_Canvas_unused_noglow_atlas_.png?1496703080575", id:"futebolonline_2017_man_Canvas_unused_noglow_atlas_"},
		{src:"sounds/apito.mp3?1496703080973", id:"apito"}
	],
	preloads: []
};
